...
const createUser = async function (req, res) {
  try {
    ...
    if (!validator.isValid(phone)) {
      return res
        .status(400)
        .send({ status: false, message: "phone must be present" });
    }
    ...
    if (
      ...
      return res
        ...
        .send({
          status: false,
          message: "Shipping address details is/are missing",
        });
    }
    ...
    if (
      ...
      return res
        ...
        .send({
          status: false,
          message: "Billing address details is/are missing",
        });
    }
  ...
  try {
    ...
    if (Object.keys(data).length >= 3) {
      return res
        ...
        .send({
          status: false,
          message: "Only Enter Email & Password In Body !!!",
        });
    }
